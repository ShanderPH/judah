...
last_update: 2026-07-29T12:04:17-03:00
...
next_action: "Review the local diff; when authorized, publish it through a PR, deploy the exact SHA, upload the Judah HubSpot Integration project, and run the authenticated smoke."
artifacts_generated:
