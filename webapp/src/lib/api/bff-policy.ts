...
const policies: readonly RoutePolicy[] = [
  ...
  { pattern: /^\/support\/helpdesk-calendar\/$/, methods: ["GET"], capability: CAPABILITIES.supportAdminRead },
  { pattern: /^\/support\/helpdesk-calendar\/rules\/$/, methods: ["GET"], capability: CAPABILITIES.supportAdminRead },
  { pattern: /^\/support\/helpdesk-calendar\/rules\/$/, methods: ["POST"], capability: CAPABILITIES.supportCalendarManage, requiresJson: true },
  { pattern: new RegExp(`^/support/helpdesk-calendar/rules/${UUID}/$`), methods: ["PATCH"], capability: CAPABILITIES.supportCalendarManage, requiresJson: true },
  { pattern: new RegExp(`^/support/helpdesk-calendar/rules/${UUID}/$`), methods: ["DELETE"], capability: CAPABILITIES.supportCalendarManage },
  { pattern: /^\/support\/helpdesk-calendar\/preview\/$/, methods: ["POST"], capability: CAPABILITIES.supportCalendarManage, requiresJson: true },
  { pattern: /^\/support\/helpdesk-calendar\/resolve\/$/, methods: ["GET"], capability: CAPABILITIES.supportAdminRead },
